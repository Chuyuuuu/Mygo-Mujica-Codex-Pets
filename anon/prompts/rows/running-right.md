Create a single horizontal sprite strip for the Codex app digital pet `anon` in the state `running-right`.
...
Output exactly 8 separate animation frames arranged left-to-right in one single row. Each frame must show the same pet: Cute chibi digital pet inspired by Chihaya Anon from BanG Dream. Preserve long pastel pink hair with soft side strands, large pale blue-gray eyes, sweet cheerful face, tiny blush, compact chibi proportions, and a friendly cute personality. Outfit must follow the main large image: grey plaid sleeveless dress, cream/white blouse with rolled sleeves, black rectangular belt buckle at the waist, white socks, chunky dark brown platform Mary Jane shoes. Use the character sheet only for identity, hair, eyes, and expression range; keep expressions softer and cuter than the more exaggerated sheet sketches..

Style contract: Codex digital pet sprite style: pixel-art-adjacent low-resolution mascot sprite, compact chibi proportions, chunky whole-body silhouette, thick dark 1-2 px outline, visible stepped/pixel edges, limited palette, flat cel shading with at most one small highlight and one shadow step, simple readable face, tiny limbs, and no detail that disappears at 192x208. Avoid polished illustration, painterly rendering, anime key art, 3D render, vector app-icon polish, glossy lighting, soft gradients, realistic fur or material texture, anti-aliased high-detail edges, and complex tiny accessories. Additional user style notes: Codex digital pet house style: small pixel-art-adjacent mascot, chunky readable silhouette, thick dark 1-2 px outline, stepped pixel edges, flat cel shading, limited palette, no polished anime illustration, no gradients, no shadows, no text, no scenery, no detached effects. Use a flat removable chroma-key background and keep generous padding..
